...
interface SimpleSimonColumnProps {
  id: SimpleSimonTableauId
  cards: Card[]
...
function DraggableCard({
  ...
  return (
    ...
    >
      <SimpleSimonCard card={card} isHidden={isHidden} />
    </div>
  )
}

export default function SimpleSimonColumn({
  id,
  cards,
  draggableFrom,
}: SimpleSimonColumnProps) {
  ...
  // Tighten vertical offset for 10 columns to save space
