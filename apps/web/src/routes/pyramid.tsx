  ...
  return (
    <main className="flex h-full flex-col bg-primary px-6 py-10">
      <div className="relative mb-6 flex items-center">
        ...
        <h1 className="absolute left-1/2 -translate-x-1/2 rounded-lg bg-sky-100 px-4 py-1 text-2xl font-bold text-sky-900 dark:bg-sky-950 dark:text-sky-100">Pyramid</h1>
      </div>
