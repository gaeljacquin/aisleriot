...
- Always include the `Co-authored-by` trailer exactly as shown above — this attributes the commit to both the developer and the AI
...
- Documentation files live directly in `docs/` (not in a subdirectory)
